...
namespace DevKitTranslator
{
    public static class DevKitTranslatorFunction
    {
        ...
        const string speechSubscriptionKey = "984444a6566f45669052c72c6a62b13f";
        ...
        const string speechServiceRegion = "westeurope";

        // Device ID
        const string deviceName = "TeamSixteeenMXChip";
